...
if(isset($_POST['signupSubmit'])){
    ...
    if(!empty($_POST['email'])){
		...
		if($prevUser > 0){
			...
			if($update){
				$resetPassLink = 'http://localhost/pruebaproyecto/olvidopass-master/resetpass.php?fp_code='.$uniqidStr;
    ...
    header("Location:seteolvidolac.php");
    ...
    $_SESSION['sessData'] = $sessData;
    $redirectURL = ($sessData['status']['type'] == 'success')?'index.php':'resetpass.php?fp_code='.$fp_code;
